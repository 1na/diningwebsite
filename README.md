...
This fork is for a website in development. 
...
Edit `/pages/_posts/2016-3-1-Sixes.md` to publish your first blog post. This [Markdown Cheatsheet](http://www.jekyllnow.com/Markdown-Style-Guide/) might come in handy.
